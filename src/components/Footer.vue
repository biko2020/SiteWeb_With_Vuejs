  ...
  <v-app>
    ...
    <div class="container py-5">
      <div id="app" v-if="logo === 'logo_Fournisseurs'">
        <sequential-entrance>
          <v-img class="box" src="@/assets/logo/fournisseurs/alfa.png"> </v-img>
          ...
          <v-img class="box" src="@/assets/logo/fournisseurs/idea.png"> </v-img>
          ...
          <v-img class="box" src="@/assets/logo/fournisseurs/cleananvac.png">
          </v-img>
          <v-img class="box" src="@/assets/logo/fournisseurs/lega.png"> </v-img>
        </sequential-entrance>
      </div>
    </div>
    <!--- --- --- --- ------- --- --- --- --->
